...
void main() {
  ...
  group('get top rated', () {
    final jsonName = 'dummy_data/tv_top_rated.json';
    final testList =
  ...
  group('get popular', () {
    final jsonName = 'dummy_data/tv_popular.json';
    final testList =
        TvResponse.fromJson(json.decode(readJson(jsonName))).tvList;
    test('should return valid tv list when status code is 200', () async {
      // arrange
  ...
  group('get detail tv', () {
    final jsonName = 'dummy_data/tv_detail.json';
    final testId = 1;
  ...
  group('get recommendations tv', () {
    final jsonName = 'dummy_data/tv_recommendations.json';
    final testId = 1;
    final testList =
        TvResponse.fromJson(json.decode(readJson(jsonName))).tvList;
  ...
  group('search tv', () {
    final jsonName = 'dummy_data/tv_alice_search.json';
  ...
  group('get season detail', () {
    final jsonName = 'dummy_data/season_detail.json';
    final testId = 1;
    final testModel =
