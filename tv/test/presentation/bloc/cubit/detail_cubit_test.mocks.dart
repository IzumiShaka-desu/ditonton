...
// in tv/test/presentation/bloc/cubit/detail_cubit_test.dart.
...
import 'package:tv/domain/usecases/get_tv_recommendations.dart' as _i10;
import 'package:tv/domain/usecases/get_watchlist_tv_status.dart' as _i12;
import 'package:tv/domain/usecases/remove_tv_watchlist.dart' as _i9;
import 'package:tv/domain/usecases/save_tv_watchlist.dart' as _i8;
...
class MockGetTvRecommendations extends _i1.Mock
  ...
  _i2.TvRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeTvRepository_0()) as _i2.TvRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i11.Tv>>> execute(dynamic id) =>
      (super.noSuchMethod(Invocation.method(#execute, [id]),
